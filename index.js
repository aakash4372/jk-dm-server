...
const getOwnerEmailTemplate = (fullName, email, contactNumber, companyName, message) => `
  <div style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;">
    <div style="max-width: 600px; background: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.2);">
      ...
      <!-- Footer Section -->
      <hr>
      <p style="text-align: center; font-size: 14px; color: #777;">This email was automatically generated by Jk-DigitalMarketing.</p>
    </div>
  </div>
`;
...
const getUserEmailTemplate = (fullName, message) => `
  <div style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;">
    <div style="max-width: 600px; background: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.2);">
      ...
      <p>If you need immediate assistance, please contact us at <a href="mailto:support@jkdigital.com" style="color: #007bff;">support@jkdigital.com</a></p>

      <!-- Footer Section -->
      <hr>
      <p style="text-align: center; font-size: 14px; color: #777;">📍 Jk-DigitalMarketing | <a href="https://www.jkdigital.com" style="color: #007bff;">www.jkdigital.com</a></p>
    </div>
  </div>
`;
